...
public class DiscussshangjiaxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussshangjiaxinxiEntity discussshangjiaxinxi,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussshangjiaxinxiEntity discussshangjiaxinxi, 
		HttpServletRequest request){
        EntityWrapper<DiscussshangjiaxinxiEntity> ew = new EntityWrapper<DiscussshangjiaxinxiEntity>();
    ...
    public R info(@PathVariable("id") Long id){
		...
		discussshangjiaxinxi = discussshangjiaxinxiService.selectView(new EntityWrapper<DiscussshangjiaxinxiEntity>().eq("id", id));
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussshangjiaxinxiEntity discussshangjiaxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussshangjiaxinxiEntity> ew = new EntityWrapper<DiscussshangjiaxinxiEntity>();
